...
public class MinecraftBindingConstants {
    ...
    public final static String CHANNEL_BUKKIT_VERSION = "bukkitVersion";
    ...
    public final static String CHANNEL_PLAYER_NAME = "playerName";
    ...
    public final static String CHANNEL_PLAYER_LOCATION_X = "playerLocationX";
    public final static String CHANNEL_PLAYER_LOCATION_Y = "playerLocationY";
    public final static String CHANNEL_PLAYER_LOCATION_Z = "playerLocationZ";
    ...
    public final static Set<ThingTypeUID> SUPPORTED_THING_TYPES_UIDS = Collections.singleton(THING_TYPE_SERVER);
}
